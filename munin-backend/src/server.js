...
const { requireAuth, requireEngagementIdInTeam, requireAnyEngagementAdmin } = require("./middleware/auth");
const app = express();
...
app.use("/api/dashboard", requireAuth(), requireEngagementIdInTeam, dashboardRoutes);
app.use("/api/sessions", requireAuth(), requireEngagementIdInTeam, sessionsRoutes);
app.use("/api/knowledge-objects", requireAuth(), requireEngagementIdInTeam, knowledgeRoutes);
app.use("/api/coverage", requireAuth(), requireEngagementIdInTeam, coverageRoutes);
app.use("/api/sme-map", requireAuth(), requireEngagementIdInTeam, smeRoutes);
app.use("/api/chat", requireAuth(), requireEngagementIdInTeam, chatRoutes);
...
app.use("/api/modules", requireAuth(), requireEngagementIdInTeam, modulesRoutes);
app.use("/api/traceability", requireAuth(), requireAnyEngagementAdmin, traceabilityRoutes);
app.use(notFound);
